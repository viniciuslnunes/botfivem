...
// Rótulo de patrimônio da torcida (bandeira, faixa, mastro, bateria) a partir do
// nome do item, ou null quando não é patrimônio. Como o jogo nomeia esses itens
// é coisa da FONTE de logs (fontes/<id>/), então isto só delega.
function nomePatrimonio(alvoNome) {
  return require('./fonte').nomePatrimonio(alvoNome);
}
